...
public class Stat_Panel_Object : MonoBehaviour
{
    ...
    {
        Text_Lists[0].text = p_Stat_Manager.attackDamage.ToString();
        Text_Lists[1].text = p_Stat_Manager.skill_Damage.ToString();
        Text_Lists[2].text = p_Stat_Manager.max_Health.ToString();
        Text_Lists[3].text = p_Stat_Manager.health.ToString();
        Text_Lists[4].text = p_Stat_Manager.movementSpeed.ToString();
        Text_Lists[5].text = p_Stat_Manager.crit_Rate.ToString() + " %";
