...
public class Bola : Enemy_Parent, Enemy_Interface, Enemy_Stun_Interface
{
    //[Header("Float Values")]
    ...
    private void Attack_Call()
    {
        ...
        if (!is_Attack_Turn) // 공격 시작 시, 플레이어 방향 보게하기
        {
            ...
            //Bola_Animator.SetTrigger("is_Attacking");
    ...
    public void Acher_Attack(/*int Alpha*/) //Left = -1, Right = 1;
    {
        ...
        Vector2 shootDirection = new Vector2(/*Alpha*/is_Left, 0.0f);
