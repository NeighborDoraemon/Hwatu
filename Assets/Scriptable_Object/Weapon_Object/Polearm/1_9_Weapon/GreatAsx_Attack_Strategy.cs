...
public class GreatAsx_Attack_Strategy : ScriptableObject, IAttack_Strategy
{
    ...
    private IEnumerator Skill_Coroutine(PlayerCharacter_Controller player)
    {
        ...
        Collider2D[] hits_First = Physics2D.OverlapBoxAll(box_Center, spin_Box_Size, 0.0f, enemy_LayerMask);
        ...
        Collider2D[] hits_Second = Physics2D.OverlapBoxAll(origin, smash_Box_Size, 0.0f, enemy_LayerMask);
